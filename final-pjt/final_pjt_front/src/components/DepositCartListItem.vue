<template>
  <div class="deposit-card cursor-pointer me-2"  data-bs-toggle="modal" 
            :data-bs-target="`#depositModal-${product.id}`" 
            >
    <div class="card">
      <div class="card-body d-flex flex-column justify-content-between">
        ...
        <div class="button-group mt-3">
          <button class="btn btn-outline-danger" @click="deleteFromDepositCart(product)">삭제</button>
        </div>
      </div>
    </div>
  </div>
