    ...
    <div class="cart-card mx-auto">
      <div class="cart-header">
        ...
        <h4 class="mt-3 mb-0" style="font-weight: bold;">
          예금상품
          <span v-if="store.likesDepositProductsCount" class="count-badge">
            {{ store.likesDepositProductsCount }}
          </span>
        </h4>
      </div>
      
      <div class="cart-body">
        <div v-if="store.depositProducts.length > 0" class="scroll-box">
...
import DepositCartListItem from './DepositCartListItem.vue';

const store = useCartStore()

onMounted(() => {
  store.getLikesDepositProducts()
})
